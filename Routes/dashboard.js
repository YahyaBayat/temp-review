   ...
   // --------------------------------------------------
    ...
    async function buyNew(orderInfo,indexBot_trading){
        ...
        if (botList[indexBot_trading]['softBuy']==true){
            ...
            let min_buy=getLowestBuyPrice(sym)
            if(data_buy.price<new_down_BuyPrice && new_down_BuyPrice< min_buy && botList[indexBot_trading]['SBF']>=0.1 && botList[indexBot_trading]['SDPB']>0 && botList[indexBot_trading]['TBF']>0){
                console.log('716:buy_follow_up=',botList[indexBot_trading].buy_follow_up);
                setTimeout(function () { soft_buy_follow(data_buy,sym) }, (botList[indexBot_trading]['TBF']) * 1000);
            }else if(data_buy.price<new_down_BuyPrice && ((botList[indexBot_trading].buy_follow_up == true) || (min_buy == 0) ) && botList[indexBot_trading]['SBF']>=0.1 && botList[indexBot_trading]['SDPB']>0 && botList[indexBot_trading]['TBF']>0){
                console.log('717:buy_follow_up=',botList[indexBot_trading].buy_follow_up);
                setTimeout(function () { soft_buy_follow(data_buy,sym) }, (botList[indexBot_trading]['TBF']) * 1000);
            }else{
                botList[indexBot_trading]['softBuy']=false;
